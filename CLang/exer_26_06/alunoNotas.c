...
int main() {
  ...
  for (int i = 0; i < numAlunos; i++) {
    ...
    // preparando o terrendo: alocando dinamicamente o espaco em memoria
    // especifico para o tamanho do buffer intermediario que foi criado
    ...
    // finalmente o buffer entrega os dados e completa mais um ciclo de vida
